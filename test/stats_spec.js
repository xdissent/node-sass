...
var includedFilesFile = path.join(__dirname, 'included_files.scss');
var sampleFile = path.join(__dirname, 'sample.scss');
var imagePathFile = path.join(__dirname, 'image_path.scss');
